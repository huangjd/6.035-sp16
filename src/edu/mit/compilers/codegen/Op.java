...
public enum Op {
  ...
  IDIV("idiv",              0b01110000000001001001101101000111, 0x50005),
  ...
  JE("je",                  0b00000100000100010000010100000111, 0),
  JNE("jne",                0b00000100000100010000010100000111, 0),
  JG("jg",                  0b00000100000100010000010100000111, 0),
  JGE("jge",                0b00000100000100010000010100000111, 0),
  JL("jl",                  0b00000100000100010000010100000111, 0),
  JLE("jle",                0b00000100000100010000010100000111, 0),

  JMP("jmp",                0b00000000000000100000001100000111, 0),
  CALL("call",              0b00000000000001001100100000000101, 0x0FC705C7),
  RET("ret",                0b00000000000000110000000000000001, 0),
  ...
  TEMP_REG("temp_reg",      0b10100000000000000001000000000010, 0),
  END_TEMP_REG(
      "end_temp_reg",       0b10100000000000000000000100000010, 0),
  BEGIN_XCALL("begin_xcall",0b10100000000000000000000100000010, 0),
  BEGIN_XDIV("begin_xdiv",  0b10100000000000000000000100000010, 0),
